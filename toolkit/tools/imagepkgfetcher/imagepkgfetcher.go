...
import (
	...
	"github.com/reubeno/CBL-Mariner/toolkit/tools/internal/packagerepo/repocloner/rpmrepocloner"
	"github.com/reubeno/CBL-Mariner/toolkit/tools/internal/packagerepo/repoutils"
...
func cloneSystemConfigs(cloner repocloner.RepoCloner, configFile, baseDirPath string, externalOnly bool, inputGraph string) (err error) {
	...
	bootType := cfg.SystemConfigs[0].BootType
	packageVersionsInConfig = append(packageVersionsInConfig, installutils.GetRequiredPackagesForInstall(bootType)...)
