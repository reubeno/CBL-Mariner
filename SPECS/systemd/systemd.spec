...
%prep
%autosetup -p1 -n systemd-252-rc2
...
ln -sfv ../run/systemd/resolve/stub-resolv.conf %{buildroot}%{_sysconfdir}/resolv.conf
...
%changelog
* Fri Oct 21 2022 Reuben Olinsky <reubeno@microsoft.com> - 252-rc2
- Upgrading to 252-rc2
